...
function TransactionsHistory({ highlightedTransactionId }) {
  ...
  return (
    <section className="gap-4 p-4 rounded-2xl bg-slate-800">
      <header className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4 text-white">
          ...
          <div className="relative">
            ...
            {isFilterOpen && (
              <div className="absolute right-0 mt-2 w-72 bg-slate-700 rounded-lg shadow-lg z-10 p-4 filter-dropdown">
      ...
      {selectionMode && selectedTransactions.length > 0 && (
        <div className="mb-4 p-3 bg-indigo-900 bg-opacity-30 rounded-lg flex justify-between items-center">
